                    ...
                    <div class="carousel-inner" style="padding: 15px;">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <div class="cart shadow bg-white rounded-lg-3 me-2">
                                        <img class="img-fluid" alt="100%x280" src="/img/вездеход.jpg">
                                        <div class="card-body">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="cart shadow bg-white rounded-lg-3 me-2">
                                        <img class="img-fluid" alt="100%x280" src="/img/pogrujic.jpg">
                                        <div class="card-body">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="cart shadow bg-white rounded-lg-3 me-2">
                                        <img class="img-fluid" alt="100%x280" src="/img/prizep.jpg">
                                        <div class="card-body">
                        ...
                        <div class="carousel-item " data-interval="10000">
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="cart shadow bg-white rounded-lg-3 me-2">
                                        <img class="img-fluid" alt="100%x280" src="/img/metalurgia.jpg">
                                        <div class="card-body">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="cart shadow bg-white rounded-lg-3 me-2">
                                        <img class="img-fluid" alt="100%x280" src="/img/zapchasti.jpg">
                                        <div class="card-body">
            ...
            <div class="col-4 cart shadow bg-white me-2 m-3">
                ...
                @forelse($news as $news)
                    <div class="cart text-left py-2 px-4 mb-5 mb-lg-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <a href="{{route('new')}}"><h3 class="small text-primary ">{{$news->name}}</h3></a>
