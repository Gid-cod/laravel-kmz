...
@section('content')
    <div class="container-fluid w-85 mt-3">
        ...
        <div class="row gap">
            <div class="col-3 ">
                ...
                <ul class="list-group sticky-top">
                    <li><a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action"
                       type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true"
                       aria-controls="collapseOne">Курган<span class="badge badge-primary badge-pill">6</span></a></li>
                    <li> <a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action"
                       type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true"
                       aria-controls="collapseOne">Москва<span class="badge badge-primary badge-pill">5</span></a></li>
                    <li><a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action"
                       type="button" data-toggle="collapse" data-target="#collapse3" aria-expanded="true"
                       aria-controls="collapse3">Челябинск<span class="badge badge-primary badge-pill">3</span></a></li>
                    <li><a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action"
                       type="button" data-toggle="collapse" data-target="#collapse4" aria-expanded="true"
                       aria-controls="collapse4">Киров<span class="badge badge-primary badge-pill">2</span></a></li>
                    <li><a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action"
                       type="button" data-toggle="collapse" data-target="#collapse5" aria-expanded="true"
                       aria-controls="collapse5">Екатеринбург<span class="badge badge-primary badge-pill">2</span></a></li>
                    <li><a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action"
                       type="button" data-toggle="collapse" data-target="#collapse6" aria-expanded="true"
                       aria-controls="collapse6">Тюмень<span class="badge badge-primary badge-pill">1</span></a></li>
                </ul>
            </div>
            <div class="col">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="cardi w-50 " style="max-width: 540px;">
                                <div class="card-body">
                                    ...
                                    <a href="https://uralrems.ru"><p class="card-text"><small class="text-muted">uralrems.ru</small></p></a>
                                </div>
                            </div>
                            <div class="cardi w-50 " style="max-width: 540px;">
                                <div class="card-body">
                            ...
                            <div class="cardi w-50 " style="max-width: 540px;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Адрес: ул. Бурова-Петрова, 123, Курган, Курганская обл.,
                                        640014</p>
                                     <p class="card-text">Тел:<a href="tel:+7 352 264-04-44" class="card-text"> +7 352 264-04-44</a></p>
                            ...
                            <div class="cardi w-50 " style="max-width: 540px;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Адрес: пр. Машиностроителей, 23, Курган, Курганская обл.,
                                        640000</p>
                                     <p class="card-text">Тел:<a href="tel:+7 352 264-00-46" class="card-text"> +7 352 264-00-46</a></p>
                            ...
                            <div class="cardi w-50 " style="max-width: 540px;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Адрес: ул. Омская, 181 к.2, Курган, Курганская обл., 641306</p>
                                     <p class="card-text">Тел:<a href="tel:+7 909 170-23-23" class="card-text"> +7 909 170-23-23</a></p>
                            ...
                            <div class="cardi w-50  " style="max-width: 540px;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Адрес: Москва, 66-й км МКАД, Деловой Центр \"Крокус Сити\"</p>
                                     <p class="card-text">Тел:<a href="tel:+7 495 780-76-75" class="card-text"> +7 495 780-76-75</a></p>
                            ...
                            <div class="cardi w-50 " style="max-width: 540px;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Адрес: владение 2 корп. 3 Северный АО RU 127591, Дубнинская
                                        ...
                                        79,
                                        Москва, 127540</p>
                                     <p class="card-text">Тел:<a href="tel:+7 800 200-05-51" class="card-text"> +7 800 200-05-51</a></p>
                            ...
                            <div class="cardi w-50 " style="max-width: 540px;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Адрес: г. Киров, ул. Производственная, д. 27, кабинет 16</p>
                                     <p class="card-text">Тел:<a href="tel:+7 800 511-85-05" class="card-text"> +7 800 511-85-05</a></p>
                            ...
                            <div class="cardi w-50 " style="max-width: 540px;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Адрес: ул. Гоголя, дом 39/1, офис 14, Томилино, Московская
                                        обл.,
                                        140070</p>
                                     <p class="card-text">Тел:<a href="tel:+7 903 253-70-62" class="card-text"> +7 903 253-70-62</a></p>
                            ...
                            <div class="cardi w-50 " style="max-width: 540px;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Адрес: ул. Расплетина, 5, Москва, 123060</p>
                                     <p class="card-text">Тел:<a href="tel:+7 495 974-37-47" class="card-text"> +7 495 974-37-47</a></p>
                            ...
                            <div class="cardi w-50 " style="max-width: 540px;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Адрес: пр. Ленина, дом 21в, офис 313, Челябинск, Челябинская
                                        обл.,
                                        454091</p>
                                     <p class="card-text">Тел:<a href="tel:+7 800 707-59-05" class="card-text"> +7 800 707-59-05</a></p>
                            ...
                            <div class="cardi w-50 " style="max-width: 540px;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Адрес: Троицкий тракт, 12, Челябинск, Челябинская обл.,
                                        454053</p>
                                     <p class="card-text">Тел:<a href="tel:+7 800 551-93-66" class="card-text"> +7 800 551-93-66</a></p>
                            ...
                            <div class="cardi w-50 " style="max-width: 540px;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Адрес: 610035, г.Киров, Мелькомбинатовский проезд, 7, Киров,
                                        Кировская обл.</p>
                                     <p class="card-text">Тел:<a href="tel:+7 800 555-96-00" class="card-text"> +7 800 555-96-00</a></p>
                            ...
                            <div class="cardi w-50 " style="max-width: 540px;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Адрес: Производственная ул., 27, Киров, Кировская обл.,
                                        610035</p>
                                     <p class="card-text">Тел:<a href="tel:+7 (800) 551-82-69" class="card-text"> +7 (800) 551-82-69</a></p>
                            ...
                            <div class="cardi w-50 " style="max-width: 540px;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Адрес: Екатеринбург, ул. Вильгельма де Генина 45</p>
                                     <p class="card-text">Тел:<a href="tel:+7 (992) 001-22-24" class="card-text"> +7 (992) 001-22-24</a></p>
                            ...
                            <div class="cardi w-50 " style="max-width: 540px;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Адрес: ул.Совхозная.20е, Екатеринбург, Свердловская обл.,
                                        620057</p>
                                     <p class="card-text">Тел:<a href="tel:+7 343 373 47 74" class="card-text"> +7 343 373 47 74</a></p>
        ...
        <div class="w-100">
            <iframe src="https://www.google.com/maps/d/embed?mid=1C4juyc6iK-fKgeD9ZDx1o3m3qBY663U&ehbc=2E312F"
                    width="640"
                    height="480"></iframe>
        </div>
